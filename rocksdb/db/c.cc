...
void rocksdb_block_based_options_set_metadata_block_size(
    rocksdb_block_based_table_options_t* options, uint64_t size) {
    options->rep.metadata_block_size = size;
}

void rocksdb_block_based_options_set_cache_index_and_filter_blocks_hign_pri(
    rocksdb_block_based_table_options_t* options, unsigned char v) {
