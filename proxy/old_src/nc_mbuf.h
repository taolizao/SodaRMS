...
#define MBUF_MEMUSE_MAX     (20480UL) //max 20GB
#define MBUF_MEMUSE_DEFAULT	(20480UL) // default 20GB
#define MBUF_MEMUSE_MIN     (512UL) //min 512MB 
#define MBUF_MEM_SOFT_LIMIT (0.6)
...
rstatus_t mbuf_read_string(struct mbuf *mbuf, const char c, struct string *read_string);
