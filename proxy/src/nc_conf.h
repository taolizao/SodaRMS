...
#define CONF_DEFAULT_QUATO                   100
#define CONF_DEFAULT_FLOW_CONTROL            false
#define CONF_DEFAULT_CLIENT_NEED_AUTH        0

#define CONF_MAX_PASSWORD_LEN                128
#define CONF_MIN_PASSWORD_LEN                1
...
struct conf_server {
    ...
    struct conf_server *master;  /* its master server if it's a slave*/
    struct array       slave;      /* slave server for read operation */
    unsigned           valid:1;    /* valid? */
};
...
struct conf_pool {
    ...
    unsigned           valid:1;               /* valid? */
    int                quota;                 /* quota of flow control */
    int                flow_control;          /* switch of flow control */
